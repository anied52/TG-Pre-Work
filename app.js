...
function displaySpeedRangeStatus() {
  availableAirplanes.forEach(function(element) {
   console.log(element.name + ' meets speed range requirements:' + meetsSpeedRangeRequirementss(element.maxSpeed, element.minSpeed, flightRequirementss.requiredSpeedRange));
  });
}
...
// Information to reach API
const apiKey = 'e4c7637ff159413d944a3cb0cb11c385';
